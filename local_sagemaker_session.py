...
class ImagenetModel(object):
    ...
    def __init__(
        ...
        # download symbol set and network if URLs are provided
        ...
        # takes an image, reshapes it
        # and runs through the loaded MXNet graph
        # for inference returning the N top labels
        ...
        # Captures an image from webcam then sends for prediction
